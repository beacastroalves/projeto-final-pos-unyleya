...
const CardProductAdmin = () => {
  ...
  return (
    ...
    // onClick={() => navigate("/products/details")}
      className="flex flex-col gap-2 justify-center items-center px-6 py-8 my-4 shadow-md rounded-md h-fit w-fit min-w-[220px] border-2 border-gray-50 bg-white cursor-pointer"
    >
      ...
      <div className="flex flex-row justify-between items-center w-full">
        ...
        <div className="flex flex-col items-center gap-1 mt-2 text-[18px]">
          ...
          <button onClick={() => alert("cliquei em apagar")} className="cursor-pointer p-1 transition duration-200 hover:text-red-700 hover:scale-150" title="Deletar Produto">
            <BiTrash />
          </button>
        </div>
      </div>
