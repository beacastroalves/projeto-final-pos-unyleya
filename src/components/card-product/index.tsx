...
const CardProduct = (props: CardProps) => {
  ...
  return (
    <button onClick={() => navigate("/products/details")} className="flex flex-col items-center justify-between p-6 my-4 mx-2 shadow-md rounded-md h-[400px] max-w-[230px] border-2 border-gray-50 bg-white cursor-pointer">
      ...
      <div className="self-start">
        ...
        <p className="w-full text-[24px] text-left">R$ {props.price}</p>
      </div>
    </button>
  )
};
