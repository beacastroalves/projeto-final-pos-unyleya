...
const CardProduct = () => {
  ...
  return (
    <button onClick={() => navigate("/products/details")} className="flex flex-col gap-2 justify-center items-center px-6 py-8 my-4 mx-2 shadow-md rounded-md h-fit w-fit min-w-[220px] border-2 border-gray-50 bg-white cursor-pointer">
