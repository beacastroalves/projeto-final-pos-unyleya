...
const CardProduct = () => {
  ...
  return (
    <button onClick={() => navigate("/products/details")} className="shadow-md rounded-md px-6 py-8 m-4 flex flex-col justify-center items-center gap-1 h-fit w-fit border-2 border-gray-50 bg-white cursor-pointer">
